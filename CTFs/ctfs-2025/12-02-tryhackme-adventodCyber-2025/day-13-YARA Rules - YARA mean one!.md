...
```
 ubuntu@tryhackme:~/Downloads/easter$ cat rule 
rule TBFC_Malhare_RegexDetect
{
    meta:
        author = "TBFC Carlos"
        description = "Extracts TBFC message"
    strings:
        $cmd = /TBFC:[A-Za-z0-9]+/ ascii
...
yara -rs ./rule .
TBFC_Malhare_RegexDetect ./easter46.jpg
0x2f78a:$cmd: TBFC:HopSec
TBFC_Malhare_RegexDetect ./easter16.jpg
0x3bb7f7:$cmd: TBFC:me
TBFC_Malhare_RegexDetect ./easter10.jpg
0x137da8:$cmd: TBFC:Find
TBFC_Malhare_RegexDetect ./easter52.jpg
0x2a2ad2:$cmd: TBFC:Island
TBFC_Malhare_RegexDetect ./easter25.jpg
0x42c778:$cmd: TBFC:in
