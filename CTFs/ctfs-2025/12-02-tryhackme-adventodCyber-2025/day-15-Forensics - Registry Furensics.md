...
3. You'll be prompted with a message indicating successful replay for transaction logs  
...
- lternatively, you can click the **Available Bookmarks** tab and navigate to the **ComputerName** key from there.
