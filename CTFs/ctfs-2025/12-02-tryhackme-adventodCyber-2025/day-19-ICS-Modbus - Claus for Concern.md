...
```
 nmap -sV -n -Pn --min-rate 5000 -p- -v 10.81.190.28 
Starting Nmap 7.95 ( https://nmap.org ) at 2025-12-19 17:36 CST
NSE: Loaded 47 scripts for scanning.
Initiating SYN Stealth Scan at 17:36
Scanning 10.81.190.28 [65535 ports]
Discovered open port 8080/tcp on 10.81.190.28
Discovered open port 22/tcp on 10.81.190.28
Discovered open port 80/tcp on 10.81.190.28
Discovered open port 502/tcp on 10.81.190.28
Discovered open port 44818/tcp on 10.81.190.28
Discovered open port 102/tcp on 10.81.190.28
Completed SYN Stealth Scan at 17:36, 13.93s elapsed (65535 total ports)
Initiating Service scan at 17:36
Scanning 6 services on 10.81.190.28
Completed Service scan at 17:39, 161.43s elapsed (6 services on 1 host)
NSE: Script scanning 10.81.190.28.
Initiating NSE at 17:39
Completed NSE at 17:39, 1.19s elapsed
Initiating NSE at 17:39
Completed NSE at 17:39, 1.19s elapsed
Nmap scan report for 10.81.190.28
...
Nmap done: 1 IP address (1 host up) scanned in 178.02 seconds
           Raw packets sent: 68125 (2.998MB) | Rcvd: 68083 (2.726MB)
...
## PORT 8080
```
http://10.81.190.28:8080/dashboard
openplc
openplc
...
Navigate to `http://10.81.190.28` in your browser.
...
>>> client = ModbusTcpClient('10.81.190.28', port=502)
>>> 
...
```
──(venv)─(root㉿kali)-[/home/kali/tmp/tryhackme-advent-2025/day19]
└─# python exp2.py 
============================================================
...
Excellent work! Now check the CCTV feed at `http://10.81.190.28` - you should see King Malhare's defeat displayed.
