...
```
# SSH settings for the hackadvisermx GitHub account
Host github.com-hackadvisermx
  Hostname github.com
  IdentityFile ~/.ssh/hackadvisermx
  IdentitiesOnly yes

# SSH settings for the castr@uaz.edu.mx GitHub account
Host github.com-castruaz
  Hostname github.com
...
```
ssh -T git@github.com-hackadvisermx
ssh -T git@github.com-castruaz
```
